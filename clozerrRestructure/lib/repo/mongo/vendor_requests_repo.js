/**
 *
 * This is the main Vendor Requests Repo,
 *
...
module.exports =  function(mongoose){
    ...
    var VendorRequestsSchema = mongoose.Schema({
        account:ObjectId,
        name:String,
        remarks:String
    });

    VendorRequestsSchema.statics.readAllD = function (data, cb) {
        var limit = data.limit || 30;
        this.find({}).limit(limit).lean().exec(cb);
    };

    return VendorRequestsSchema;
};
