...
module.exports = function( checkin, database ){
  ...
  this.request = function(){
    ...
    setTimeout( function(){
      //console.log("pushing");
      push.sendPushNotification( gcm_id, { type:"REVIEW", title: checkin.vendor.name, message:"Give us feedback on your visit to " + checkin.vendor.name + ".", "checkin_id":checkin._id, "vendor_id":checkin.vendor._id } );
    }, 2000);
  }
}
